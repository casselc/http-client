; One-assertion mutation of schannel-extra-conservation-corrected.smt2:
; arraycopy begins one byte late. Expected: sat.
...
(assert (! (= copy_start (+ (- input_length extra_length) 1))
           :named buggy_tail_copy_starts_one_byte_late))
